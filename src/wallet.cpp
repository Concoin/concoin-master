...
// concoin: total coins staked (non-spendable until maturity)
...
// concoin: check 'spent' consistency between wallet and txindex
// concoin: fix wallet spent state according to txindex
...
// concoin: disable transaction (only for coinstake)
